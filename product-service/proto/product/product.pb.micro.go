...
type AttributeService interface {
	...
	GetValues(ctx context.Context, in *Request, opts ...client.CallOption) (*AttributeValueResponse, error)
...
func (c *attributeService) GetValues(ctx context.Context, in *Request, opts ...client.CallOption) (*AttributeValueResponse, error) {
...
type AttributeServiceHandler interface {
	...
	GetValues(context.Context, *Request, *AttributeValueResponse) error
...
func RegisterAttributeServiceHandler(s server.Server, hdlr AttributeServiceHandler, opts ...server.HandlerOption) error {
	type attributeService interface {
		...
		GetValues(ctx context.Context, in *Request, out *AttributeValueResponse) error
...
func (h *attributeServiceHandler) GetValues(ctx context.Context, in *Request, out *AttributeValueResponse) error {
